...
public class Collections01 {
	...
	public static void main(String[] args) {
		...
		// HashSet 가변 배열 메모리 내부에 저장된 객체들이 어떤 것이 있는지 확인하기 위해
		// toString() 메소드를 호출해 전체 배열 모습을 문자열로 변환해서 반환받아 출력
		System.out.println(set.toString());
		// HashSet 배열에 랜덤으로 저장된 모습 문자열로 출력: "[2, 6, 넷, 하나, 여섯, 3.42, five]"
		// add(Object obj) 메소드로 HashSet 배열에 추가한 순서: "하나" -> 2 -> 3.42 -> "넷" -> "five" -> 6 -> "여섯"
		// 결론: 출력 순서가 추가한 순서와 전혀 다르다는 것을 확인할 수 있다.
