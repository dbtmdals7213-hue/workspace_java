/*
	...
	1.	매개변수의 개수를 달리해서 동일한 이름의 메소드 여러 개 작성 가능
	...
	2.	매개변수의 타입(자료형) 종류를 달리해서 동일한 이름의 메소드 여러 개 작성 가능
    ...
    3.	매개변수의 개수와 타입이 동일하지만 매개변수 작성 순서만 다른 경우에도 메소드 오버로딩 가능
	...
	주의:	 매개변수의 개수와 타입이 동일하지만 순서만 다른 경우에만 오버로딩이 가능함
...
public class Printer {
	...
	/*
		개발자가 하나 이상의 생성자를 만들어 놓지 않으면? 자바 컴파일러는 기본 생성자 하나를 자동 생성해놓는다.
	...
	*/
	...
	// 메소드 오버로딩? 같은 클래스 내부에 동일한 이름의 메소드를 여러 개 정의하는 것을 말함
