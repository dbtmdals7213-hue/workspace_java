...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("정수 5와 정수 10의 합: " + calculator.add(5, 10));
		
		/* 정수 5, 정수 10, 정수 15의 합을 구해 이 자리에 30 출력 */
		System.out.println("정수 5, 정수 10, 정수 15의 합: " + calculator.add(5, 10, 15));
		
		/* 실수 5.5, 실수 10.5의 합을 구해 이 자리에 16.0 출력 */
		System.out.println("실수 5.5, 실수 10.5의 합: " + calculator.add(5.5, 10.5));
		
		/* 정수 5, 실수 10.5의 합을 구해 이 자리에 15.5 출력 */
		System.out.println("정수 5, 실수 10.5의 합: " + calculator.add(5, 10.5));
