...
public class BitLogicExample {
	...
	public static void main(String[] args) {
		...
		*/	
		//방법1. 비트 논리 곱 연산으로 Unsigned 정수 얻기
		int Unsigned = receiveDate & 255;
		System.out.println(Unsigned);	// <--- 136
