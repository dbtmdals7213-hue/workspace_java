...
public class WebDevelopmentExample {
	...
	//															 6
	/*
		2는 0010입니다.(2진수로 2를 나타나기 위해 4번째 자리에 1을 놓고 나머지 자리는 0으로 채웁니다.)
		4는 0100입니다.(2진수로 4를 나타나기 위해 3번째 자리에 1을 놓고 나머지 자리는 0으로 채웁니다.)
		...
		각 자리의 2진수의 값을 2의 거듭 제곱으로 곱한 후에 모두 더하는 것입니다. 
	...
	*/
	...
	public static void main(String[] args) {
		...
		// -> userPermission 변수 값과 ADMIN_PERMISSION 상수 값을 비트 AND 연산자 & 를 사용하여
		//    관리자 권한을 가지고 있는지 확인
...
//						  (      6 	      &			4		) != 0;
		...
		*/
		...
		System.out.println("로그인 필요 권한을 가지며 관리자 페이지 접근 권한을 가진 관리자 권한 여부 값: " + isAdmin);
