...
//  답변3. 이후 객체들에 저장할 변수를 먼저 가져와야 하기 때문에
//
...
abstract class Employee {
	...
	abstract void printPayslip(String month);
}
//---------------------------------------------------------------------
...
class FullTimeEmployee extends Employee {
	...
	@Override
	void printPayslip(String month) {
...
class ContractEmployee extends Employee {
	...
	public ContractEmployee(String name, String empNo, String dept) {
